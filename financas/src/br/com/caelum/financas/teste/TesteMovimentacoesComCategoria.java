...
public class TesteMovimentacoesComCategoria {
	...
	public static void main(String[] args) {
		...
		movimentacao1.setDescricao("Viagem a MG");
		movimentacao1.setTipo(TipoMovimentacao.ENTRADA);
		movimentacao1.setValor(new BigDecimal("110.0"));
...
//		Movimentacao movimentacao3 = em.find(Movimentacao.class, 1005);
//		movimentacao3.setValor(new BigDecimal("1500.0"));
